...
const schema = z.object({
  ...
  happyhorseApiKey: z.string().max(4096).optional(),
  happyhorseWorkspaceId: z.string().max(512).optional(),
  happyhorseBaseUrl: optionalUrl.optional(),
  wanApiKey: z.string().max(4096).optional(),
  wanWorkspaceId: z.string().max(512).optional(),
  wanBaseUrl: optionalUrl.optional(),
  ...
  clearHappyhorseApiKey: z.boolean().optional(),
  clearWanApiKey: z.boolean().optional(),
